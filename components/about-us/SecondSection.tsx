...
const SecondSection = () => {
  return (
    <div className="bg-[#FCFBF1] my-6 px-1 py-4">
      ...
      <section>
        <h2 className="font-bold my-5 text-center text-[15px]">
        ...
        <div className="flex flex-col items-center justify-around gap-y-5 lg:flex-row">
          <section className="mx-8 text-center">
            <h3 className="flex flex-col my-2 items-center  gap-x-3 text-base font-medium">
              <span className="rounded-full bg-[#FFC048] my-1 p-[3px] text-xl text-white lg:p-[5px]">
                <IoMdBasketball />
              </span>
              Extensive Selection
            </h3>
            <p className="font-serif text-sm  my-1 pl-1">
